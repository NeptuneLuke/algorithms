...
public class radixSort {
	...
	public static void radixSort(int myArray[]) {
	    ...
	    while(max/pos > 0){
			countingSort(myArray, pos);
			pos *= 10;		//shift to other digits
	    }
	    
	}
	
	
	public static void countingSort(int myArray[], int pos) {
